    ...
    return (
      <section className="flex-col">
        ...
        <p>
          ...
          collection. This project is currently being created by one person so
          be patient in the progress of the app. This site is current in {phase}{' '}
          and plan to add more features as time goes on.
        </p>
        <h2>Current Features</h2>
        <ul>
          <li>Card search via card name.</li>
          <li>
            Add cards to collection and stored through the browser's local
            storage
          </li>
          <li>
        ...
        <ul>
          ...
          <li>Card effect probability calculator</li>
          <li>Random MtG related games</li>
        </ul>
        <p>
          If you are interested contributing you can communicate to me through
          the GitHub's repo issues 
          <a target="_blank" href="https://github.com/grassfinn/MtgCollection/issues">Card StackS Repo</a>
        </p>
      </section>
    );
}